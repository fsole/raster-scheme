...
(provide make-vertex)
(provide vertex-position)
(provide vertex-normal)
(provide vertex-uv)


(provide make-triangle)
(provide triangle-get-vertex)
(provide barycentric) 
(provide point-in-triangle?)
(provide aabb-from-triangle)

(provide make-mesh)
(provide mesh-vertices)
(provide mesh-indices)
(provide mesh-get-triangle-count)
(provide mesh-get-triangle) 
